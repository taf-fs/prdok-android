    ...
    Column(modifier = modifier.fillMaxWidth()) {
        ...
        when (load) {
            ...
            is FreeShiftsLoad.Loaded -> if (load.shifts.isEmpty()) {
                ...
                ShiftDayTimeline(
                    entries = load.shifts.map { timelineEntry(it.start, it.end, it.role) },
                    onOpenDay = onOpenDay,
...
private fun previewShift(id: Int, day: Int, from: Int, to: Int, role: ShiftRole = ShiftRole.REGULAR): FreeShift {
            ...
            FreeShiftsSection(
                load = FreeShiftsLoad.Loaded(
                    listOf(
                        ...
                        previewShift(3, 17, 7, 11, ShiftRole.BARISTA),
                        previewShift(4, 17, 16, 0),
                        previewShift(5, 17, 17, 0),
                        previewShift(6, 20, 8, 11, ShiftRole.MANAGER),
